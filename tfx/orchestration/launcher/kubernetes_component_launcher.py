...
class KubernetesComponentLauncher(base_component_launcher.BaseComponentLauncher
  ...
  def _wait_pod(self, core_api: client.CoreV1Api, pod_name: Text,
                namespace: Text, exit_condition_lambda: Callable[[client.V1Pod],
                                                                 bool],
                condition_description: Text, timeout_sec: int) -> client.V1Pod:
